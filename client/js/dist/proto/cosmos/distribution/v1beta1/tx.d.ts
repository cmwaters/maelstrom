...
export declare const MsgWithdrawDelegatorRewardResponse: {
    ...
    create<I extends {} & {} & { [K in Exclude<keyof I, never>]: never; }>(base?: I): MsgWithdrawDelegatorRewardResponse;
    fromPartial<I_1 extends {} & {} & { [K_1 in Exclude<keyof I_1, never>]: never; }>(_: I_1): MsgWithdrawDelegatorRewardResponse;
};
...
export declare const MsgWithdrawValidatorCommissionResponse: {
    ...
    create<I extends {} & {} & { [K in Exclude<keyof I, never>]: never; }>(base?: I): MsgWithdrawValidatorCommissionResponse;
    fromPartial<I_1 extends {} & {} & { [K_1 in Exclude<keyof I_1, never>]: never; }>(_: I_1): MsgWithdrawValidatorCommissionResponse;
};
