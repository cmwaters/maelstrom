...
func request_Maelstrom_AccountInfo_0(ctx context.Context, marshaler runtime.Marshaler, client MaelstromClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Maelstrom_AccountInfo_0(ctx context.Context, marshaler runtime.Marshaler, server MaelstromServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq AccountInfoRequest
	var metadata runtime.ServerMetadata
...
func RegisterMaelstromHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MaelstromServer) error {
	...
	mux.Handle("GET", pattern_Maelstrom_AccountInfo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/maelstrom.v1.Maelstrom/AccountInfo", runtime.WithHTTPPathPattern("/account_info/{address}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Maelstrom_AccountInfo_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_Maelstrom_AccountInfo_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterMaelstromHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MaelstromClient) error {
	...
	mux.Handle("GET", pattern_Maelstrom_AccountInfo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/maelstrom.v1.Maelstrom/AccountInfo", runtime.WithHTTPPathPattern("/account_info/{address}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Maelstrom_AccountInfo_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_Maelstrom_AccountInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1}, []string{"account_info", "address"}, ""))
)
...
var (
	...
	forward_Maelstrom_AccountInfo_0 = runtime.ForwardResponseMessage
)
